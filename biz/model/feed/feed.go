...
type FeedRequest struct {
	LastTime int64  `thrift:"last_time,1" form:"last_time" json:"last_time" query:"last_time"`
...
type FeedResponse struct {
	...
	VideoList  []*favorite_gorm.Video `thrift:"video_list,3" form:"video_list" json:"video_list" query:"video_list"`
...
func (p *FeedResponse) GetVideoList() (v []*favorite_gorm.Video) {
	return p.VideoList
}
...
func (p *FeedResponse) ReadField3(iprot thrift.TProtocol) error {
	...
	p.VideoList = make([]*favorite_gorm.Video, 0, size)
	for i := 0; i < size; i++ {
		_elem := favorite_gorm.NewVideo()
...
type FeedService interface {
	QueryFeedList(ctx context.Context, req *FeedRequest) (r *FeedResponse, err error)
}
...
func (p *FeedServiceClient) QueryFeedList(ctx context.Context, req *FeedRequest) (r *FeedResponse, err error) {
	var _args FeedServiceQueryFeedListArgs
	_args.Req = req
	var _result FeedServiceQueryFeedListResult
	if err = p.Client_().Call(ctx, "QueryFeedList", &_args, &_result); err != nil {
		return
	}
...
func NewFeedServiceProcessor(handler FeedService) *FeedServiceProcessor {
	...
	self.AddToProcessorMap("QueryFeedList", &feedServiceProcessorQueryFeedList{handler: handler})
	return self
}
...
type feedServiceProcessorQueryFeedList struct {
	handler FeedService
}

func (p *feedServiceProcessorQueryFeedList) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := FeedServiceQueryFeedListArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("QueryFeedList", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := FeedServiceQueryFeedListResult{}
	var retval *FeedResponse
	if retval, err2 = p.handler.QueryFeedList(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing QueryFeedList: "+err2.Error())
		oprot.WriteMessageBegin("QueryFeedList", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("QueryFeedList", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
...
type FeedServiceQueryFeedListArgs struct {
	Req *FeedRequest `thrift:"req,1"`
}

func NewFeedServiceQueryFeedListArgs() *FeedServiceQueryFeedListArgs {
	return &FeedServiceQueryFeedListArgs{}
}

var FeedServiceQueryFeedListArgs_Req_DEFAULT *FeedRequest

func (p *FeedServiceQueryFeedListArgs) GetReq() (v *FeedRequest) {
	if !p.IsSetReq() {
		return FeedServiceQueryFeedListArgs_Req_DEFAULT
	}
	return p.Req
}

var fieldIDToName_FeedServiceQueryFeedListArgs = map[int16]string{
	1: "req",
}

func (p *FeedServiceQueryFeedListArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *FeedServiceQueryFeedListArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_FeedServiceQueryFeedListArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *FeedServiceQueryFeedListArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *FeedServiceQueryFeedListArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("QueryFeedList_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *FeedServiceQueryFeedListArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *FeedServiceQueryFeedListArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("FeedServiceQueryFeedListArgs(%+v)", *p)
}

type FeedServiceQueryFeedListResult struct {
	Success *FeedResponse `thrift:"success,0,optional"`
}

func NewFeedServiceQueryFeedListResult() *FeedServiceQueryFeedListResult {
	return &FeedServiceQueryFeedListResult{}
}

var FeedServiceQueryFeedListResult_Success_DEFAULT *FeedResponse

func (p *FeedServiceQueryFeedListResult) GetSuccess() (v *FeedResponse) {
	if !p.IsSetSuccess() {
		return FeedServiceQueryFeedListResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_FeedServiceQueryFeedListResult = map[int16]string{
	0: "success",
}

func (p *FeedServiceQueryFeedListResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *FeedServiceQueryFeedListResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_FeedServiceQueryFeedListResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *FeedServiceQueryFeedListResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *FeedServiceQueryFeedListResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("QueryFeedList_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
...
func (p *FeedServiceQueryFeedListResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *FeedServiceQueryFeedListResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("FeedServiceQueryFeedListResult(%+v)", *p)
}
