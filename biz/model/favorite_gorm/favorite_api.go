...
type Video struct {
	...
	Author        *follower_gorm.User `thrift:"author,2" form:"author" json:"author" query:"author"`
...
var Video_Author_DEFAULT *follower_gorm.User

func (p *Video) GetAuthor() (v *follower_gorm.User) {
	if !p.IsSetAuthor() {
...
func (p *Video) ReadField2(iprot thrift.TProtocol) error {
	p.Author = follower_gorm.NewUser()
...
type FavoriteActionResponse struct {
	StatusCode follower_gorm.Code `thrift:"status_code,1" form:"status_code" json:"status_code" query:"status_code"`
...
func (p *FavoriteActionResponse) GetStatusCode() (v follower_gorm.Code) {
	return p.StatusCode
}
...
func (p *FavoriteActionResponse) ReadField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI32(); err != nil {
		...
		p.StatusCode = follower_gorm.Code(v)
	}
	return nil
}
...
func (p *FavoriteListResponse) GetStatusCode() (v follower_gorm.Code) {
	return p.StatusCode
}
